...
const highlights = [
  ...
  },
  {
    ...
    desc: "Over 15 experienced faculty members with Higher qualifications and industry experience.",
  },
];
      ...
      <section className="bg-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl sm:text-4xl font-bold text-[#14532d] mb-3">
              Why Choose Us?
            </h2>
            <p className="text-gray-600 text-lg max-w-2xl mx-auto">
              We are committed to providing top-quality pharmaceutical education
              with a focus on practical skills and research.
            </p>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {highlights.map((item) => (
              ...
              >
                ...
                <h3 className="text-lg font-semibold text-[#14532d] mb-2">
                  {item.title}
                </h3>
      ...
      <section className="bg-[#f0fdf4] py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-end mb-10">
            <div>
              <h2 className="text-3xl sm:text-4xl font-bold text-[#14532d] mb-2">
                Our Programs
              </h2>
              <p className="text-gray-600">
                Industry-aligned courses for your pharmaceutical career.
              </p>
            </div>
            <Link
              href="/courses"
              className="hidden sm:inline-flex items-center gap-1 text-[#166534] font-semibold hover:underline text-sm"
            >
              View All
              <svg
                className="w-4 h-4"
          ...
          <div className="text-center mt-8 sm:hidden">
            <Link
              href="/courses"
              className="inline-flex items-center gap-1 text-[#166534] font-semibold hover:underline"
            >
              View All Courses
            </Link>
          </div>
            ...
            {/* <div>
              ...
              <ul className="space-y-3">
                {[
                  {
                    date: "Mar 20, 2026",
                    text: "Admissions open for B.Pharm 2026-27 batch. Apply before April 30.",
                  },
                  {
                    date: "Mar 15, 2026",
                    text: "National Pharmacy Week seminar on March 28. All students must attend.",
                  },
                  {
                    date: "Mar 10, 2026",
                    text: "Practical examinations schedule for III semester published.",
                  },
                  {
                    date: "Mar 05, 2026",
                    text: "Campus placement drive by MedPharma Ltd. on April 5, 2026.",
                  },
                  {
                    date: "Feb 28, 2026",
                    text: "Library extended hours during examination period: 7 AM – 10 PM.",
                  },
                ].map((notice, i) => (
                  <li
                    key={i}
                    className="flex gap-4 p-4 rounded-lg border border-gray-100 hover:border-[#22c55e] hover:bg-[#f0fdf4] transition-all duration-200"
                  >
                ...
                {[
                  {
                    ...
                    desc: "MedPharma Ltd. visiting for B.Pharm & M.Pharm recruitments.",
                  },
                  {
                    month: "APR",
                    day: "15",
                    title: "Annual Science Exhibition",
                    desc: "Students showcase pharmaceutical research and innovations.",
                  },
                  {
                    month: "MAY",
                    day: "01",
                    title: "Last Date – B.Pharm Admission",
                    desc: "Deadline for admission applications for 2026-27.",
                  },
                  {
                    month: "MAY",
                    day: "20",
                    title: "Fresher's Orientation",
                    desc: "Welcome ceremony for new batch of students.",
                  },
                ].map((event, i) => (
                  <div
                    key={i}
                    className="flex gap-4 p-4 rounded-lg border border-gray-100 hover:shadow-md transition-shadow duration-200"
                  >
      ...
      <section className="bg-gradient-to-r from-[#19703a] to-[#186838] py-14">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="text-green-200 mb-8 text-lg">
            Join thousands of successful pharmacists who started their journey
            here.
          </p>
          <div className="flex flex-wrap justify-center gap-4">
            <Link
              href="/admissions"
              className="px-8 py-3 bg-white text-[#166534] font-bold rounded-lg hover:bg-gray-100 transition-colors shadow-lg"
            >
              Apply for Admission
            </Link>
            <Link
              href="/contact"
              className="px-8 py-3 border-2 border-white text-white font-bold rounded-lg hover:bg-white hover:text-[#166534] transition-colors"
            >
              Contact Us
            </Link>
          </div>
