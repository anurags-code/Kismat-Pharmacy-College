    ...
    <>
      ...
      <section className="bg-gradient-to-br from-[#f0fdf4] to-[#dcfce7] py-14">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl sm:text-5xl font-extrabold text-[#14532d] mb-3">Contact Us</h1>
          <p className="text-gray-600 text-lg max-w-2xl">
            We are here to help. Reach out to us for admissions, academic queries, or general information.
          </p>
        </div>
      </section>
      ...
      <section className="bg-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            {/* Contact Info */}
            <div>
              <h2 className="text-2xl font-bold text-[#14532d] mb-8">Get In Touch</h2>
              <div className="space-y-5">
                {contactInfo.map((info) => (
                  <div key={info.label} className="flex items-start gap-4 p-4 rounded-xl border border-gray-100 hover:border-[#22c55e] hover:bg-[#f0fdf4] transition-all duration-200">
                    <div className="w-10 h-10 bg-[#166534] rounded-lg flex items-center justify-center text-white shrink-0">
                      {info.icon}
                    </div>
                    <div>
                      <p className="text-xs font-semibold text-gray-500 uppercase tracking-wider mb-0.5">{info.label}</p>
                      {info.link ? (
                        <a href={info.link} className="text-gray-800 text-sm font-medium hover:text-[#166534] transition-colors">{info.value}</a>
                      ) : (
              ...
              {/* Departments */}
              <div className="mt-8">
                <h3 className="text-lg font-bold text-[#14532d] mb-4">Department Contacts</h3>
                <div className="space-y-2">
                  {[
                    { dept: 'Admissions Office', email: 'admissions@kismatpharmacy.edu.in', phone: '+91 12345 67891' },
                    { dept: 'Academic Office', email: 'academics@kismatpharmacy.edu.in', phone: '+91 12345 67892' },
                    { dept: 'Placement Cell', email: 'placement@kismatpharmacy.edu.in', phone: '+91 12345 67893' },
                  ].map((d) => (
                    <div key={d.dept} className="p-3 rounded-lg bg-[#f0fdf4] border border-green-100 text-sm">
                      <p className="font-semibold text-[#14532d]">{d.dept}</p>
                      <p className="text-gray-600 text-xs mt-0.5">{d.email} | {d.phone}</p>
                    </div>
                  ))}
                </div>
              </div>
            ...
            {/* Contact Form */}
            <div>
              <h2 className="text-2xl font-bold text-[#14532d] mb-8">Send Us a Message</h2>
              ...
              {submitted ? (
                <div className="bg-[#f0fdf4] rounded-xl p-8 text-center border border-green-200">
                  ...
                  <h3 className="text-xl font-bold text-[#14532d] mb-2">Message Sent!</h3>
                  <p className="text-gray-600 text-sm mb-5">Thank you for reaching out. Our team will get back to you within 24–48 hours.</p>
                  <button
      ...
      <section className="bg-[#f0fdf4] py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-2xl font-bold text-[#14532d] mb-6 text-center">Find Us</h2>
          <div className="rounded-xl overflow-hidden border border-green-100 shadow-sm bg-[#e8f5e9] h-64 flex items-center justify-center">
            <div className="text-center">
              <svg className="w-12 h-12 text-[#166534] mx-auto mb-3" fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24">
                <path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0118 0z" /><circle cx="12" cy="10" r="3" />
              </svg>
              <p className="text-[#166534] font-semibold">123 Pharmacy Road, Medical District</p>
